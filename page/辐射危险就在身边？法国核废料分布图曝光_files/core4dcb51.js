...
define("appmsg/topbar.js",["biz_wap/jsapi/core.js","biz_wap/utils/mmversion.js","common/comm_report.js","pages/utils.js","biz_common/dom/event.js","common/utils.js"],function(e){
"use strict";
function i(e){
e="undefined"!=typeof e?e:!1;
var i={
userName:g.userName,
brandName:g.bizNickName,
title:g.title,
brandIcon:g.headImg,
topBarStyle:v?1:0,
topBarShowed:e,
...
if(""!==g.itemShowType&&null!==g.itemShowType&&void 0!==g.itemShowType&&_extends(i,{
itemShowType:g.itemShowType
}),""!==g.showSourceInfo&&_extends(i,{
showSourceInfo:g.showSourceInfo
}),"0"===g.itemShowType)_extends(i,{
...
var t=g.voiceid||0,o=g.duration||0;
_extends(i,{
audioUrl:location.protocol+"//res.wx.qq.com/voice/getvoice?mediaid="+t,
audioLen:o
});
}
m.invoke("currentMpInfo",i);
}
function t(){
v&&m.invoke("currentMpInfoShow",{
userName:g.userName,
brandName:g.bizNickName
});
}
function o(){
v&&m.invoke("currentMpInfoHide");
}
function n(){
v&&(i(),w.getScrollTop()>g.showTitleHeight&&t());
}
function r(e){
var i=parseInt(Date.now()/1e3,10);
g.reportData.EnterId=g.reportData.EnterId&&10===g.reportData.EnterId.toString().length?g.reportData.EnterId:i;
var t=1*(w.getScrollTop()+w.getInnerHeight()),o=_extends(g.reportData,{
Event:e,
...
e>=g.showTitleHeight&&!f?(f=!0,v?(m.invoke("currentMpInfoShow",{
userName:g.userName,
brandName:g.bizNickName
}),b||(r(1),b=!0)):document.title=g.bizNickName):e<g.showTitleHeight&&f&&(f=!1,v?m.invoke("currentMpInfoHide"):document.title="");
}
function c(){
l.bindVisibilityChangeEvt(function(e){
!e&&w.getScrollTop()>=g.showTitleHeight&&(i(),t());
});
}
function d(){
var e=arguments.length<=0||void 0===arguments[0]?{}:arguments[0];
e.bizNickName||(e.bizNickName=v?"未命名公众号":e.bizNickNameBackup);
for(var t in e)e[t]&&(g[t]=e[t]);
g.bizNickName=g.bizNickName.htmlDecode(),g.title=g.title.htmlDecode(),g.headImg=g.headImg.replace(/\/0$/,"/132"),
i(),a(),c(),l.on(window,"load",function(){
document.title="",s();
}),l.on(window,"scroll",N),window.addEventListener("pageshow",function(e){
e.persisted&&n();
});
}
var m=e("biz_wap/jsapi/core.js"),u=e("biz_wap/utils/mmversion.js"),p=e("common/comm_report.js"),h=e("pages/utils.js"),l=e("biz_common/dom/event.js"),w=e("common/utils.js"),g={
showTitleHeight:40,
userName:"",
bizNickName:"",
bizNickNameBackup:"",
...
v="5"===g.itemShowType?u.isIOS&&u.gtVersion("7.0.12",!0)||u.isAndroid&&u.gtVersion("7.0.12",!0):u.isIOS&&u.gtVersion("7.0.10",!0)||u.isAndroid&&u.gtVersion("7.0.12",!0);
var N=h.throttle(s,50);
return{
setCurrentMpInfo:i,
showCurrentMpInfo:t,
hideCurrentMpInfo:o,
...
});define("common/utils.js",["biz_common/utils/url/parse.js","biz_wap/jsapi/core.js","biz_wap/utils/wapsdk.js","biz_wap/utils/storage.js","biz_wap/utils/device.js","biz_wap/utils/mmversion.js"],function(e){
"use strict";
function t(){
return"1"===n.getQuery("isNativePage")||"2"===n.getQuery("isNativePage");
}
var n=e("biz_common/utils/url/parse.js"),i=e("biz_wap/jsapi/core.js"),o=e("biz_wap/utils/wapsdk.js"),r=e("biz_wap/utils/storage.js"),a=e("biz_wap/utils/device.js"),s=e("biz_wap/utils/mmversion.js");
try{
...
var u=[],g=[],p=new r("history4secondopen"),l="from",d=!1,h={
status:"loading"
},f=[],w={
isNativePage:t,
...
__useWcSlPlayer:!1,
isWcSlPage:function(){
return w.__useWcSlPlayer;
},
getPlayerType:function(){
return w.isWcSlPage()?3:t()?2:1;
},
getParam:function(e){
if(!e)return null;
...
window.__second_open__&&"string"==typeof e&&/^https?:\/\/mp.weixin.qq.com\//.test(e)&&p.set(l,location.href,Date.now()+1e4),
location.href=e.replace(/#.*$/,"")+"#wechat_redirect";
},
initNewPageHistoryStackFromSecOpen:function(){
var e=p.get(l);
if(e&&"string"==typeof e&&/^https?:\/\/mp.weixin.qq.com\//.test(e)&&(p.remove(l),
...
d||(d=!0,window.addEventListener("popstate",function(e){
e.state&&1===e.state.__mock_secopen_history_stack_reload__&&location.reload();
}));
},
initWebCompt:function(e,t){
((a.os.iphone||a.os.ipad)&&s.isWechat&&s.gtVersion("7.0.14",1)||a.os.android&&s.isWechat&&s.gtVersion("7.0.15",1))&&!function(){
var n=function(){
for(;f.length;){
var e=f.shift();
e(h);
...
console.log("wx config web compt",e,i),i&&i.err_msg&&-1===i.err_msg.indexOf(":ok")&&(h={
status:"error",
error:i.err_msg
...
return"function"!=typeof e?h:("loading"===h.status?f.push(e):e(h),!0);
}
};
return w;
